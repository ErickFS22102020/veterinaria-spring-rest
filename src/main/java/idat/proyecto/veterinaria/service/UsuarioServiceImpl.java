...
public class UsuarioServiceImpl implements UsuarioService {
	...
	public ResponseEntity<?> insert(Usuario usuario) {
		...
		ResponseEntity<?> existUsuario = isExistUsername(usuario.getUsername());
		if (existUsuario.getStatusCode() == HttpStatus.FOUND) return existUsuario;
	...
	public ResponseEntity<?> update(Integer id, Usuario usuario) {
		...
		ResponseEntity<?> existUsuario = isExistUsername(usuario.getUsername());
		if (existUsuario.getStatusCode() == HttpStatus.FOUND) {
			@SuppressWarnings("unchecked")
			String usernameFound = ((HashMap<String,String>) existUsuario.getBody()).get("username");
			if (!usernameFound.equals(usuarioFound.getUsername())) return existUsuario;
		}
